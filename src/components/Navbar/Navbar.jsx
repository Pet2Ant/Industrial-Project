...
const AuthenticatedNavbar = ({userKind}) => (
    ...
    <div className='space-x-4'>
        ...
        <Link to='/cvBuilder' className='text-[#143727] hover:text-gray-300 p-2'><button className="bg-[#8D93D9] text-[#143727] rounded-full px-4 py-2">
        See applications
        </button></Link>
        <Link to='/logout' className='text-[#143727] hover:text-gray-300 p-2'><button className="bg-[#143727] text-[#e5e5e5] rounded-full px-4 py-2">
            Log out
        </button></Link>
    </div>
        ) : (
